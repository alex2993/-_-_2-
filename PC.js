...
for (let i = 0; i < buttonAddFirst.length; i++) {
  buttonAddFirst[i].addEventListener('click', (event) => {
    ...
    btnValueLocal[idEl] = {
      ...
      cost: Number(event.srcElement.parentElement.parentElement.children[2].textContent.split('₽').join('')),
      src: event.srcElement.parentElement.parentElement.children[0].src,
      str: event.srcElement.parentElement.parentElement.children[1].textContent
    }
